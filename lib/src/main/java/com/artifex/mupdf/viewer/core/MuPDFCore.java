...
public class MuPDFCore {
    ...
    private void flattenOutlineNodes(
        ...
        for (Outline node : list) {
            ...
            if (node.title != null) {
                ...
                result.add(new OutlineItem(indent + node.title, page));
            }
    ...
    public synchronized ArrayList<OutlineItem> getOutline() {
